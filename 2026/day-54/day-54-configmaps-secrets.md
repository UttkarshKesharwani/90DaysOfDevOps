...
![default.conf file](./default.conf)
...
![task 3 continue](./screenshot/image-3.png)

![busybox yml file](./manifest/busybox-pod.yml)
![nginx yml file](./manifest/nginx-pod.yml)
...
![task 5](./screenshot/image-5.png)
![secret key ref yml file](./manifest/secretkeyref-pod.yml)
...
![task 6](./screenshot/image-6.png)
![update configmap yml](./manifest/update-configmap.yml)